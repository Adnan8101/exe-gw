...
export default {
  data: new SlashCommandBuilder()
    .setName('purgebefore')
    .setDescription('Delete messages before a specific message')
    .addStringOption(option => option.setName('messageid').setDescription('Message ID to purge before').setRequired(true))
