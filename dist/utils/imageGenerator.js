...
exports.generateBirthdayImage = generateBirthdayImage;
const canvas_1 = require("canvas");
const discord_js_1 = require("discord.js");
const path = __importStar(require("path"));
async function generateBirthdayImage(user, guild) {
    // Register Font
    try {
        const fontPath = path.join(__dirname, '../assets/GreatVibes-Regular.ttf');
        (0, canvas_1.registerFont)(fontPath, { family: 'GreatVibes' });
    }
    catch (e) {
    ...
    try {
        ...
        const background = await (0, canvas_1.loadImage)(bgPath);
    ...
    return new discord_js_1.AttachmentBuilder(canvas.toBuffer(), { name: 'birthday.png' });
}
